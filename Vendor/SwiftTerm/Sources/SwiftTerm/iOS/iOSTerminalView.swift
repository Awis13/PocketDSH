...
open class TerminalView: UIScrollView, UITextInputTraits, UIKeyInput, UIScrollViewDelegate, TerminalDelegate {
    ...
    /// Optional explicit face for a character, for example private-use symbols
    /// which CoreText does not reliably resolve through the ordinary cascade.
    public var characterFont: ((Character) -> UIFont?)?
