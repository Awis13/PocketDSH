...
Current integration evidence and limits: `docs/NATIVE-CHAT-INTEGRATION.md`. Historical comparisons: `docs/FEATURE-PARITY-AUDIT.md`, `docs/WARP-FEATURE-AUDIT.md`, `docs/NATIVE-HARNESS-RESEARCH.md`.
